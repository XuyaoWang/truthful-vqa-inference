...
from truthful_vqa_inference.benchmarks.truthful_vqa_high.utils import create_occlusion

@BenchmarkRegistry.register("truthfulvqa-high")
class TruthfulVQAHighEvaluator(BenchmarkEvaluator):
    """
    ...
    def prepare_input_item(self, item: Dict[str, Any]) -> Tuple[str, str, Any]:
        ...
        image = create_occlusion(item['image'], level='high')
